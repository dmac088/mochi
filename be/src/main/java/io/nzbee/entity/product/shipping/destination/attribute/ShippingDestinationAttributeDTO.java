...
public class ShippingDestinationAttributeDTO implements Serializable {
	...
	public ShippingDestinationAttributeDTO(Object[] tuple, Map<String, Integer> aliasToIndexMap) {
	...
	public ShippingDestinationAttributeDTO(Long 		shippingDestinationId,
