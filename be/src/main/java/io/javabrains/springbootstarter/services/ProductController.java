...
public class ProductController {
    ...
    public Page<Product> getProducts(@PathVariable String lcl, @PathVariable String curr, @PathVariable int page, @PathVariable int size, @PathVariable String sortBy) {
    ...
    public Page<Product> getProducts(@PathVariable String lcl, @PathVariable String curr, @PathVariable String category, @PathVariable int page, @PathVariable int size, @PathVariable String sortBy) {
    ...
    public Page<Product> getProducts(@PathVariable String lcl, @PathVariable String curr, @PathVariable String category, @PathVariable String brand, @PathVariable int page, @PathVariable int size, @PathVariable String sortBy) {
    ...
    public Page<Product> getProducts(@PathVariable String lcl, @PathVariable String curr, @PathVariable String category, @PathVariable Long price, @PathVariable int page, @PathVariable int size, @PathVariable String sortBy) {
    ...
    public Page<Product> getProducts(@PathVariable String lcl, @PathVariable String curr, @PathVariable String category, @PathVariable String brand, @PathVariable Long price, @PathVariable int page, @PathVariable int size, @PathVariable String sortBy) {
    ...
    public Page<Product> search(@PathVariable String lcl, @PathVariable String curr, @PathVariable String categoryCode,@PathVariable String term, @PathVariable int page, @PathVariable int size, @PathVariable String sortBy) {
