...
public class BrowseProductResultDto  extends RepresentationModel<PhysicalProductLightResource> {

	private PagedModel<EntityModel<PhysicalProductLightResource>> products;
	
	public BrowseProductResultDto(PagedModel<EntityModel<PhysicalProductLightResource>> products) {
