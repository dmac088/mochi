...
GRANT SELECT ON TABLE permission TO mochi_app;
...
GRANT SELECT,USAGE ON SEQUENCE authority_id_seq TO mochi_app;
...
GRANT SELECT,USAGE ON SEQUENCE role_id_seq TO mochi_app;
...
GRANT SELECT ON TABLE role TO mochi_app;
...
GRANT SELECT,USAGE ON SEQUENCE role_permission_id_seq TO mochi_app;
...
GRANT SELECT ON TABLE role_permission TO mochi_app;
...
GRANT SELECT,USAGE ON SEQUENCE user_role_id_seq TO mochi_app;
