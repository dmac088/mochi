...
@NamedNativeQueries({
	...
	query = 
		...
		@NamedNativeQuery(
			name = "Product.getProductsForCategoryAndBrand.count",
			resultSetMapping = "ProductMapping.count",
			query = 
					"WITH RECURSIVE    " + 
	...
	@NamedNativeQuery(
			name = "Product.getProductsForCategoryAndBrand",
			resultSetMapping = "ProductMapping",
			query = 
					"WITH RECURSIVE    " + 
					"primary_descendants AS    " + 
	...
	@NamedNativeQuery(
		name = "Product.getProductsForCategoryAndBrandAndTag.count",
		resultSetMapping = "ProductMapping.count",
		query = 
				"WITH RECURSIVE    " + 
				"primary_descendants AS    " + 
		...
		@NamedNativeQuery(
		name = "Product.getProductsForCategoryAndBrandAndTag",
		resultSetMapping = "ProductMapping",
		query = 
				"WITH RECURSIVE    " + 
				"primary_descendants AS    " + 
