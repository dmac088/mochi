...
public class IT_ShippingTypeUploadForUpdateIntegrationTest {
	...
	public void uploadShippingTypes() {
		...
		pms.writeShippingTypeMaster(file.getAbsolutePath() + "/data/product/shipping/type/update/type_master.tsv");
	}
	...
	private void assertFound_ENGB(Optional<ShippingTypeDTO> found) {
	...
	private void assertFound_ZHHK(Optional<ShippingTypeDTO> found) {
