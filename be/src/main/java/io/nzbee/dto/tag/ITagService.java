...
public interface ITagService extends IService<Tag> {
	...
	List<Tag> findAll(String locale, String currency, String categoryDesc, List<CategoryWithNameAndStats> categories,
			List<Brand> brands);

	List<Tag> findAll(String locale, String currency, String categoryDesc, Double price, List<CategoryWithNameAndStats> categories,
			List<Brand> brands);
