...
public class PromotionBNGNFMasterService {
	...
	public void writePromotionMaster(String fileName) {
		...
		try {
			...
			MappingIterator<PromotionBNGNFSchema> readValues = mapper.readerFor(PromotionBNGNFSchema.class)
	...
	public void persistPromotionMaster(PromotionBNGNFSchema pms) {
		...
		p.setFreeQty(Integer.parseInt(pms.get_FREE_QUANTITY()));
