...
public class PhysicalProductLightDTO extends ProductDTO implements Serializable {
	...
	public PhysicalProductLightDTO(Object[] tuple, Map<String, Integer> aliasToIndexMap) {
