...
export default Header;
            ...
            //                         <form action="#" method="get" className={props.mobileSearch ? "search-form active" : "search-form"}>
            ...
            //                                 <button type="button" className={props.cart.length > 0 ? " " : "disabled"}>PROCEED TO CHECKOUT</button>
            //                             </div>
            //                         </div>
            //                     </div>
            //                 </div>
