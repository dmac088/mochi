      ...
      <React.Fragment>
        ...
        <div className="product-content">
          <div className="product-categories">
            <a id={product.productUPC} href={(e) => routeSingleProduct(e, category.categoryDesc, routeProps, category.categoryDesc, routeProps)} href="#">{category.categoryDesc}</a>,<span> </span>
