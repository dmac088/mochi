...
@Component
public class ProductResourceAssembler extends RepresentationModelAssemblerSupport<ProductView, ProductResource> {
	...
	@Override
	public ProductResource toModel(ProductView product) {
