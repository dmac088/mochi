...
public class BrandDomainDTO implements ISearchDimension, Serializable {
	...
	public BrandDomainDTO(Object[] tuple, Map<String, Integer> aliasToIndexMap) {
	...
	public BrandDomainDTO(Long brandId, String brandCode, String brandDesc, String locale) {
		super();
