                                        ...
                                        <div className="tab-content product-large-image-list">
                                            <div className="tab-pane fade show active" id="single-slide1" role="tabpanel" aria-labelledby="single-slide-tab-1">
                                                <div className="single-product-img easyzoom img-full">
                                                    <img src="assets/images/big-product-image/product04.jpg" className="img-fluid" alt="" />
                                                    <a href="assets/images/big-product-image/product04.jpg" className="big-image-popup"><i className="fa fa-search-plus"></i></a>
                                                </div>
                                            </div>
                                            <div className="tab-pane fade" id="single-slide2" role="tabpanel" aria-labelledby="single-slide-tab-2">
                                                <div className="single-product-img easyzoom img-full">
                                                    <img src="assets/images/big-product-image/product05.jpg" className="img-fluid" alt="" />
                                                    <a href="assets/images/big-product-image/product05.jpg" className="big-image-popup"><i className="fa fa-search-plus"></i></a>
                                                </div>
                                            </div>
                                            <div className="tab-pane fade" id="single-slide3" role="tabpanel" aria-labelledby="single-slide-tab-3">
                                                <div className="single-product-img easyzoom img-full">
                                                    <img src="assets/images/big-product-image/product06.jpg" className="img-fluid" alt="" />
                                                    <a href="assets/images/big-product-image/product06.jpg" className="big-image-popup"><i className="fa fa-search-plus"></i></a>
                                                </div>
                                            </div>
                                            <div className="tab-pane fade" id="single-slide4" role="tabpanel" aria-labelledby="single-slide-tab-4">
                                                <div className="single-product-img easyzoom img-full">
                                                    <img src="assets/images/big-product-image/product07.jpg" className="img-fluid" alt="" />
                                                    <a href="assets/images/big-product-image/product07.jpg" className="big-image-popup"><i className="fa fa-search-plus"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-6 col-md-12 col-xs-12">
                                    <div className="product-feature-details">
                                        ...
                                        <div className="single-product-action-btn mb-20">
                                            <a href="#" data-tooltip="Add to wishlist"> <span className="icon_heart_alt"></span> Add to wishlist</a>
                                            <a href="#" data-tooltip="Add to compare"> <span className="arrow_left-right_alt"></span> Add to compare</a>
                                        </div>
                                        ...
                                        <div className="tab-slider-wrapper">
                                            <nav>
                                                <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                                    <a className="nav-item nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab"
                                                    aria-selected="true">Description</a>
                                                    <a className="nav-item nav-link" id="features-tab" data-toggle="tab" href="#features" role="tab"
