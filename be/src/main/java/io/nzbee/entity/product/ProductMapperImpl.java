		...
		if(dto instanceof ProductDTO) {
			Product pO = new BasicProduct(
					dto.getProductUPC(),
				   	...
				   	dto.getProductStatus().getProductStatusCode(),
				   	dto.getProductAttribute().getProductShortDesc(),
				   	dto.getProductAttribute().getProductLongDesc(),
				   	dto.getRetailPrice(),
				   	dto.getMarkdownPrice(),
				   	dto.getProductAttribute().getProductImage(),
				   	dto.getLocale(),
				   	dto.getCurrency(),
				   	dto.isInStock(),
