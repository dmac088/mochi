...
public class ProductDTO {
    ...
    public String toString() {
        ...
        builder.append("UserDto [productId=").append(productId).append(", productUPC=").append(productUPC).append(", productCreateDt=").append(productCreateDt).append(", productDesc=").append(productDesc).append(", productRrp=").append(productRrp)
