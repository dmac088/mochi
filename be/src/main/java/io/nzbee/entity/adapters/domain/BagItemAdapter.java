...
@Service
public class BagItemAdapter implements IBagItemPortService {
	...
	public void delete(BagItem domainObject) {
		...
		Optional<PersonEntity> op = personService.findByUsernameAndRole(domainObject.getBag().getCustomer().getUserName(), Constants.partyRoleCustomer);
